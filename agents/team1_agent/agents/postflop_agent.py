...
postflop_agent = Agent(
  ...
  name="postflop_agent",
  description="Post-flop decision agent that bases its action only on tool outputs from monte_carlo_probabilities (no self math). Chooses among the provided actions, sets amounts by the strings in actions, and returns the final JSON.",
